...
import Column from './heat-loss-calculation-column';
import Item from './heat-loss-calculation-item';
...
type HeatLossCalculationBlockProps = { block: BlockType; index: number };

const HeatLossCalculationBlock = memo(({ block, index }: HeatLossCalculationBlockProps) => {
  const { id } = useParams();
...
export default HeatLossCalculationBlock;
