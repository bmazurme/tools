...
import Column from './calculation-meter-column';
import Item from './calculation-meter-item';
...
type CalculationMeterBlockProps = { block: BlockType; index: number };

const CalculationMeterBlock = memo(({ block, index }: CalculationMeterBlockProps) => {
  const { id } = useParams();
...
export default CalculationMeterBlock;
