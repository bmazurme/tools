...
import Column from './collector-calculation-column';
import Item from './collector-calculation-item';
...
type CollectorCalculationBlockProps = { block: BlockType; index: number };

const CollectorCalculationBlock = memo(({ block, index }: CollectorCalculationBlockProps) => {
  const { id } = useParams();
...
export default CollectorCalculationBlock;
