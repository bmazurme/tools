...
import Column from './pipe-diameter-calculation-column';
import Item from './pipe-diameter-calculation-item';
...
type PipeDiameterCalculationBlockProps = { block: BlockType; index: number };

const PipeDiameterCalculationBlock = memo(({ block, index }: PipeDiameterCalculationBlockProps) => {
  const { id } = useParams();
...
export default PipeDiameterCalculationBlock;
